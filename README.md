...
- 主页侧边栏最后一项提供 BiliNil 工具，顶部提供封面下载和视频下载选项卡切换：封面下载支持 av、BV、直播间和 `b23.tv` 输入解析，展示并下载封面到系统 `Downloads/Nilset`；视频下载为占位页。BiliNil 使用独立网络栈，不携带 Nilset 登录凭据，封面下载仅允许 B站图片 CDN 域名。
